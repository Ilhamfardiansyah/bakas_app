            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('coba.post') }}">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <input type="number" class="form-control @error('stok') is-invalid @enderror" id="stok"
                                    onkeyup="sum();" name="stok" value="{{ old('stok') }}" required>
                                @error('stok')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group col-md-2">
                                <label for="detail_id"
                                    class="form-label @error('detail_id') is-invalid @enderror">Detail</label>
                                <div class="form-group">
                            ...
                            <div class="form-group col-md-2">
                                <label for="size_id"
                                    class="form-label @error('size_id') is-invalid @enderror">Size</label>
                                <div class="form-group">
                                ...
                                <button class="btn btn-info" data-toggle="modal" data-target="#exampleSize">Tambah
                                    Size</button>
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control @error('sub_total') is-invalid @enderror"
                                    id="sub_total" onkeyup="sum();" name="sub_total" value="{{ old('sub_total') }}"
                                    required readonly>
                                @error('sub_total')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <button type="submit" class="btn btn-success"><i class="fa-solid fa-plus"></i> Tambah
                            Barang</button>
                    </form>
                    @include('modal.size')
                </div>
                ...
                <table class="table table-head-fixed text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="/edit/{{ $post->plu }}" class="btn btn-success">Edit</a></td>
                            @endforeach
                    </tbody>
                    <tfoot>
                        <tr>
